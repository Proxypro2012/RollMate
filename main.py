...
from period_selection import PeriodSelection   # Imports Seperated Class (Vital!)
from kivy.app import App
from kivy.uix.boxlayout import BoxLayout
from kivy.uix.button import Button
from kivy.uix.label import Label
...
class UserInfoPopup(Popup):
    ...
    def save_user_data(self, instance):
        ...
        if portal == "teacher":
                self.main_page.add_widget(TeacherDashboard())
        #self.main_page.add_widget(PeriodSelection())
